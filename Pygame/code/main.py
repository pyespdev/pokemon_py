...
class Game:
	...
	def import_assets(self):
		...
		self.monster_frames = {
			...
			'attacks': attack_importer('Pygame', 'graphics', 'attacks')
		}
		...
		self.start_animation_frames = import_folder('Pygame', 'graphics', 'other', 'star animation')
	
		self.audio = audio_importer('Pygame', 'audio')
